        ...
        <div style="width: 100%; position: absolute;top: 5px; padding-left: 10px;">
            ...
            <div class="btn-toolbar" role="toolbar" style="background-color: #F7F7F7; height: 50px; position: relative;top: 10px;">
                <div class="btn-group" style="position: relative; top: 18%;">
                    <button type="button" class="btn btn-primary" onclick="window.location.href='create.jsp';"><span class="glyphicon glyphicon-plus"></span> 创建</button>
            ...
            <div style="height: 50px; position: relative;top: 20px;">
                ...
                <div class="btn-group" style="position: relative;top: -34px; margin-left: 110px;">
